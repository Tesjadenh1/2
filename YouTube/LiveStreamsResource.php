...
class Google_Service_YouTube_LiveStreams_Resource extends Google_Service_Resource
{
  ...
  public function insert($part, LiveStream $postBody, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), 'Google_Service_LiveStream');
  }
  /**
  ...
  public function listLiveStreams($part, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), 'Google_Service_LiveStreamListResponse');
  }
  /**
  ...
  public function update($part, LiveStream $postBody, $optParams = array())
  {
    $params = array('part' => $part, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), 'Google_Service_LiveStream');
  }
}
