...
class Google_Service_Calendar_Calendars_Resource extends Google_Service_Resource
{
  ...
  public function get($calendarId, $optParams = array())
  {
    $params = array('calendarId' => $calendarId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), 'Google_Service_Calendar');
  }
  /**
  ...
  public function insert(Calendar $postBody, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), 'Google_Service_Calendar');
  }
  /**
  ...
  public function patch($calendarId, Calendar $postBody, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), 'Google_Service_Calendar');
  }
  /**
  ...
  public function update($calendarId, Calendar $postBody, $optParams = array())
  {
    $params = array('calendarId' => $calendarId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), 'Google_Service_Calendar');
  }
}
