...
class Google_Service_AdExchangeBuyer_BudgetResource extends Google_Service_Resource
{
  ...
  public function get($accountId, $billingId, $optParams = array())
  {
    ...
    return $this->call('get', array($params), 'Google_Service_Budget');
  }
  /**
  ...
  public function patch($accountId, $billingId, Budget $postBody, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), 'Google_Service_Budget');
  }
  /**
   * Updates the budget amount for the budget of the adgroup specified by the
  ...
  public function update($accountId, $billingId, Budget $postBody, $optParams = array())
  {
    $params = array('accountId' => $accountId, 'billingId' => $billingId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), 'Google_Service_Budget');
  }
}
