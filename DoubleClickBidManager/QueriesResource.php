...
class Google_Service_DoubleClickBidManager_Queries_Resource extends Google_Service_Resource
{
  ...
  public function createquery(Query $postBody, $optParams = array())
  {
    ...
    return $this->call('createquery', array($params), 'Google_Service_Query');
  }
  /**
  ...
  public function getquery($queryId, $optParams = array())
  {
    $params = array('queryId' => $queryId);
    $params = array_merge($params, $optParams);
    return $this->call('getquery', array($params), 'Google_Service_Query');
  }
  /**
  ...
  public function listqueries($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('listqueries', array($params), 'Google_Service_ListQueriesResponse');
  }
  /**
