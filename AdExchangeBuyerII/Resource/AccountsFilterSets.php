...
class Google_Service_AdExchangeBuyerII_Resource_AccountsFilterSets extends Google_Service_Resource
{
   ...
   *
   * @param string $accountId Account ID of the buyer.
   * @param int $filterSetId The ID of the filter set to delete.
   * @param array $optParams Optional parameters.
   ...
   *
   * @param string $accountId Account ID of the buyer.
   * @param int $filterSetId The ID of the filter set to get.
   * @param array $optParams Optional parameters.
   * @return Google_Service_AdExchangeBuyerII_FilterSet
   */
   ...
   * (filterSets.getBidMetrics)
   *
   * @param string $accountId Account ID of the buyer.
   * @param int $filterSetId The ID of the filter set to apply.
   * @param array $optParams Optional parameters.
   * @return Google_Service_AdExchangeBuyerII_BidMetrics
   */
  public function getBidMetrics($accountId, $filterSetId, $optParams = array())
  {
    $params = array('accountId' => $accountId, 'filterSetId' => $filterSetId);
    $params = array_merge($params, $optParams);
    return $this->call('getBidMetrics', array($params), "Google_Service_AdExchangeBuyerII_BidMetrics");
  }
  /**
   * Gets all metrics that are measured in terms of number of impressions.
   * (filterSets.getImpressionMetrics)
   *
   * @param string $accountId Account ID of the buyer.
   * @param int $filterSetId The ID of the filter set to apply.
   * @param array $optParams Optional parameters.
   * @return Google_Service_AdExchangeBuyerII_ImpressionMetrics
   */
  public function getImpressionMetrics($accountId, $filterSetId, $optParams = array())
  {
    $params = array('accountId' => $accountId, 'filterSetId' => $filterSetId);
    $params = array_merge($params, $optParams);
    return $this->call('getImpressionMetrics', array($params), "Google_Service_AdExchangeBuyerII_ImpressionMetrics");
  }
  /**
