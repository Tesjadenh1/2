...
class Google_Service_Dns_ManagedZonesResource extends Google_Service_Resource
{
  ...
  public function create($project, ManagedZone $postBody, $optParams = array())
  {
    ...
    return $this->call('create', array($params), 'Google_Service_ManagedZone');
  }
  /**
  ...
  public function get($project, $managedZone, $optParams = array())
  {
    $params = array('project' => $project, 'managedZone' => $managedZone);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), 'Google_Service_ManagedZone');
  }
  /**
  ...
  public function listManagedZones($project, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), 'Google_Service_ManagedZonesListResponse');
  }
}
