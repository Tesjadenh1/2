...
class Google_Service_Dfareporting_DirectorySitesResource extends Google_Service_Resource
{
  ...
  public function get($profileId, $id, $optParams = array())
  {
    ...
    return $this->call('get', array($params), 'Google_Service_DirectorySite');
  }
  /**
  ...
  public function insert($profileId, DirectorySite $postBody, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), 'Google_Service_DirectorySite');
  }
  /**
  ...
  public function listDirectorySites($profileId, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), 'Google_Service_DirectorySitesListResponse');
  }
}
