...
class Google_Service_Dfareporting_FloodlightConfigurations_Resource extends Google_Service_Resource
{
  ...
  public function get($profileId, $id, $optParams = array())
  {
    ...
    return $this->call('get', array($params), 'Google_Service_FloodlightConfiguration');
  }
  /**
  ...
  public function listFloodlightConfigurations($profileId, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), 'Google_Service_FloodlightConfigurationsListResponse');
  }
  /**
  ...
  public function patch($profileId, $id, FloodlightConfiguration $postBody, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), 'Google_Service_FloodlightConfiguration');
  }
  /**
  ...
  public function update($profileId, FloodlightConfiguration $postBody, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), 'Google_Service_FloodlightConfiguration');
  }
}
