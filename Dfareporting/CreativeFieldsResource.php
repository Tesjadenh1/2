...
class Google_Service_Dfareporting_CreativeFieldsResource extends Google_Service_Resource
{
  ...
  public function get($profileId, $id, $optParams = array())
  {
    $params = array('profileId' => $profileId, 'id' => $id);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), 'Google_Service_CreativeField');
  }
  /**
   ...
   * @return Google_Service_CreativeField
   */
  public function insert($profileId, CreativeField $postBody, $optParams = array())
  {
    $params = array('profileId' => $profileId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), 'Google_Service_CreativeField');
  }
  /**
  ...
  public function listCreativeFields($profileId, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), 'Google_Service_CreativeFieldsListResponse');
  }
  /**
   ...
   * @return Google_Service_CreativeField
   */
  public function patch($profileId, $id, CreativeField $postBody, $optParams = array())
  {
    $params = array('profileId' => $profileId, 'id' => $id, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), 'Google_Service_CreativeField');
  }
  /**
   ...
   * @return Google_Service_CreativeField
   */
  public function update($profileId, CreativeField $postBody, $optParams = array())
  {
    $params = array('profileId' => $profileId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), 'Google_Service_CreativeField');
  }
}
