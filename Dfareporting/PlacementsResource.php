...
class Google_Service_Dfareporting_PlacementsResource extends Google_Service_Resource
{
  ...
  public function generatetags($profileId, $optParams = array())
  {
    ...
    return $this->call('generatetags', array($params), 'Google_Service_PlacementsGenerateTagsResponse');
  }
  /**
  ...
  public function get($profileId, $id, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), 'Google_Service_Placement');
  }
  /**
   ...
   * @return Google_Service_Placement
   */
  public function insert($profileId, Placement $postBody, $optParams = array())
  {
    $params = array('profileId' => $profileId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), 'Google_Service_Placement');
  }
  /**
  ...
  public function listPlacements($profileId, $optParams = array())
  {
    $params = array('profileId' => $profileId);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), 'Google_Service_PlacementsListResponse');
  }
  /**
   ...
   * @return Google_Service_Placement
   */
  public function patch($profileId, $id, Placement $postBody, $optParams = array())
  {
    $params = array('profileId' => $profileId, 'id' => $id, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), 'Google_Service_Placement');
  }
  /**
   ...
   * @return Google_Service_Placement
   */
  public function update($profileId, Placement $postBody, $optParams = array())
  {
    $params = array('profileId' => $profileId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), 'Google_Service_Placement');
  }
}
