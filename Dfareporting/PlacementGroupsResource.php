...
class Google_Service_Dfareporting_PlacementGroups_Resource extends Google_Service_Resource
{
  ...
  public function get($profileId, $id, $optParams = array())
  {
    ...
    return $this->call('get', array($params), 'Google_Service_PlacementGroup');
  }
  /**
  ...
  public function insert($profileId, PlacementGroup $postBody, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), 'Google_Service_PlacementGroup');
  }
  /**
  ...
  public function listPlacementGroups($profileId, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), 'Google_Service_PlacementGroupsListResponse');
  }
  /**
  ...
  public function patch($profileId, $id, PlacementGroup $postBody, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), 'Google_Service_PlacementGroup');
  }
  /**
  ...
  public function update($profileId, PlacementGroup $postBody, $optParams = array())
  {
    $params = array('profileId' => $profileId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), 'Google_Service_PlacementGroup');
  }
}
