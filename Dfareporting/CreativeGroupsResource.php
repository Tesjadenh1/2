...
class Google_Service_Dfareporting_CreativeGroupsResource extends Google_Service_Resource
{
   ...
   * @return Google_Service_CreativeGroup
   */
  public function insert($profileId, CreativeGroup $postBody, $optParams = array())
  {
   ...
   * @return Google_Service_CreativeGroup
   */
  public function patch($profileId, $id, CreativeGroup $postBody, $optParams = array())
  {
   ...
   * @return Google_Service_CreativeGroup
   */
  public function update($profileId, CreativeGroup $postBody, $optParams = array())
  {
    $params = array('profileId' => $profileId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
