...
class Google_Service_Dfareporting_AdsResource extends Google_Service_Resource
{
  ...
  public function get($profileId, $id, $optParams = array())
  {
    ...
    return $this->call('get', array($params), 'Google_Service_Ad');
  }
  /**
   ...
   * @return Google_Service_Ad
   */
  public function insert($profileId, Ad $postBody, $optParams = array())
  {
    $params = array('profileId' => $profileId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), 'Google_Service_Ad');
  }
  /**
  ...
  public function listAds($profileId, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), 'Google_Service_AdsListResponse');
  }
  /**
   ...
   * @return Google_Service_Ad
   */
  public function patch($profileId, $id, Ad $postBody, $optParams = array())
  {
    $params = array('profileId' => $profileId, 'id' => $id, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), 'Google_Service_Ad');
  }
  /**
   ...
   * @return Google_Service_Ad
   */
  public function update($profileId, Ad $postBody, $optParams = array())
  {
    $params = array('profileId' => $profileId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), 'Google_Service_Ad');
  }
}
