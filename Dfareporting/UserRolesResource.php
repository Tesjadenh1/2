...
class Google_Service_Dfareporting_UserRolesResource extends Google_Service_Resource
{
  ...
  public function get($profileId, $id, $optParams = array())
  {
    $params = array('profileId' => $profileId, 'id' => $id);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), 'Google_Service_UserRole');
  }
  /**
   ...
   * @return Google_Service_UserRole
   */
  public function insert($profileId, UserRole $postBody, $optParams = array())
  {
    $params = array('profileId' => $profileId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), 'Google_Service_UserRole');
  }
  /**
  ...
  public function listUserRoles($profileId, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), 'Google_Service_UserRolesListResponse');
  }
  /**
   ...
   * @return Google_Service_UserRole
   */
  public function patch($profileId, $id, UserRole $postBody, $optParams = array())
  {
    $params = array('profileId' => $profileId, 'id' => $id, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), 'Google_Service_UserRole');
  }
  /**
   ...
   * @return Google_Service_UserRole
   */
  public function update($profileId, UserRole $postBody, $optParams = array())
  {
    $params = array('profileId' => $profileId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), 'Google_Service_UserRole');
  }
}
