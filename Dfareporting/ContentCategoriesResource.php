...
class Google_Service_Dfareporting_ContentCategoriesResource extends Google_Service_Resource
{
  ...
  public function get($profileId, $id, $optParams = array())
  {
    $params = array('profileId' => $profileId, 'id' => $id);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), 'Google_Service_ContentCategory');
  }
  /**
  ...
  public function insert($profileId, ContentCategory $postBody, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), 'Google_Service_ContentCategory');
  }
  /**
  ...
  public function listContentCategories($profileId, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), 'Google_Service_ContentCategoriesListResponse');
  }
  /**
  ...
  public function patch($profileId, $id, ContentCategory $postBody, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), 'Google_Service_ContentCategory');
  }
  /**
  ...
  public function update($profileId, ContentCategory $postBody, $optParams = array())
  {
    $params = array('profileId' => $profileId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), 'Google_Service_ContentCategory');
  }
}
