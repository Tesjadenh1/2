...
class Google_Service_ShoppingContent_AccountshippingResource extends Google_Service_Resource
{
  ...
  public function custombatch(AccountshippingCustomBatchRequest $postBody, $optParams = array())
  {
    ...
    return $this->call('custombatch', array($params), 'Google_Service_AccountshippingCustomBatchResponse');
  }
  /**
  ...
  public function get($merchantId, $accountId, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), 'Google_Service_AccountShipping');
  }
  /**
  ...
  public function listAccountshipping($merchantId, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), 'Google_Service_AccountshippingListResponse');
  }
  /**
  ...
  public function patch($merchantId, $accountId, AccountShipping $postBody, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), 'Google_Service_AccountShipping');
  }
  /**
  ...
  public function update($merchantId, $accountId, AccountShipping $postBody, $optParams = array())
  {
    $params = array('merchantId' => $merchantId, 'accountId' => $accountId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), 'Google_Service_AccountShipping');
  }
}
